...
const Register = () => {
  ...
  return (
    <> <section className="relative min-h-screen overflow-hidden bg-[#090A0F] px-4 py-10 text-zinc-100">
      ...
      <div className="relative z-10 mx-auto flex min-h-[85vh] w-full max-w-5xl items-center justify-center"> <div className="w-full max-w-md rounded-2xl border border-[#31b8c6]/40 bg-zinc-900/70 p-8 shadow-2xl backdrop-blur"> <h1 className="text-3xl font-bold text-[#31b8c6]">
        Create Account </h1>
